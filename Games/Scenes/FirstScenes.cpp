...
FirstScenes::FirstScenes(sf::RenderWindow* window) : GameState(window)
{
    ...
    if (!this->bg_t.loadFromFile("/Users/yangyaohui/Desktop/Arhway/C-Game/assets/textures/ClassRoomScenes.png"))
    {
        std::cout << "Error loading texture" << std::endl;
    }
    this->background.setTexture(&this->bg_t);

    this->p1t.loadFromFile("/Users/yangyaohui/Desktop/Arhway/C-Game/assets/textures/p1.png");
    this->p1.setTexture(p1t);
    p1.setPosition(-200, 20);
    p1.setScale(1.0, 1.2);

    this->p2t.loadFromFile("/Users/yangyaohui/Desktop/Arhway/C-Game/assets/textures/p2.png");
...
void FirstScenes::update(const float& dt)
{
...
void FirstScenes::render(sf::RenderTarget* target)
{
    ...
    this->guide->render_guide(target);
}